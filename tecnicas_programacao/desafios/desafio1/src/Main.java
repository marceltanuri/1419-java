...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Pessoa joao = new Pessoa("João da Silva", LocalDate.of(1960, 3, 10), Sexo.MASCULINO, MeuConstrutorDeListas.criarLista(regJoao1, regJoao2));
        ...
        List<Pessoa> pessoas = MeuConstrutorDeListas.criarLista(joao, maria, carlos, ana);
        ...
        for (Pessoa pessoa : pessoas) {
            ...
            System.out.println("Resultado atual: " + pessoa.calcularAposentadoria());
            System.out.println("---");
        }
    }
}
